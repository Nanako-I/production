                                                ...
                                                <div class="border-2 p-2 rounded-lg bg-white m-2">
                                                    <div class="flex justify-start items-center">
                                                        ...
                                                        <p class="font-bold text-xl ml-2">送迎:
                                                            <span>
                                                            @if ($person->scheduledVisits->where('arrival_datetime', '>=', now()->startOfDay())->where('arrival_datetime', '<=', now()->endOfDay())->first()->transport === '必要')
                        必要
                    @elseif ($person->scheduledVisits->where('arrival_datetime', '>=', now()->startOfDay())->where('arrival_datetime', '<=', now()->endOfDay())->first()->transport === '不要')
                        不要
                    @else
                        未登録
                    @endif
