          ...
          <div>
            ...
            <div class="mt-1 flex border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-indigo-500">
                <div class="flex items-center mr-4">
                    <input type="radio" id="transport_yes" name="transport" value="1" required class="mr-2">
                    <label for="transport_yes" class="text-sm">必要</label>
                </div>
                <div class="flex items-center">
                    <input type="radio" id="transport_no" name="transport" value="0" required class="mr-2">
